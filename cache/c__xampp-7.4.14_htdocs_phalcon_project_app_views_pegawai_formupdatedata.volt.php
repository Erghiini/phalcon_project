<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form action="/phalcon_project/Pegawai/updateData" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>NIP</label>
                            <input type="text" class="form-control" name="nip" placeholder="NIP" value="<?= $nip; ?>">
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                        ...
                        <div class="form-group">
                            <label>No. HP</label>
                            <input type="text" class="form-control" name="nohp" placeholder="No. HP" value="<?= $nohp; ?>">
                        </div>
                    </div>                
                </div>
            </div>
